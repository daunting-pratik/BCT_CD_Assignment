// saurav  080bct083/* Create a class person with name and DOB as data members. Ask the user to enter a date of birth and print all person name with a matched date of birth */
#include <iostream>
#include <string>
